          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/50 p-8 rounded-xl">
              <p className="text-gray-400 text-lg leading-relaxed">
                Na OpenSky, transformamos tecnologia em crescimento real para o seu negócio. Atuamos como uma empresa de soluções digitais completas, desenvolvendo sistemas sob medida, softwares eficientes, automações inteligentes e experiências digitais que otimizam processos e aumentam resultados.
                <br /><br />
                Combinamos estratégia, inovação e desenvolvimento de alto nível para oferecer soluções personalizadas de acordo com a necessidade de cada cliente. Nossa missão é impulsionar empresas com ferramentas tecnológicas modernas, acessíveis e escaláveis.
                <br /><br />
                Seja por meio de sistemas internos inteligentes, plataformas de agendamento, integração de dados ou presença digital profissional, a OpenSky é parceira da sua evolução. Criamos tecnologia com propósito: gerar eficiência, valor e crescimento sustentável.
                <br /><br />
                <span className="font-bold text-white">OpenSky — Desenvolva o potencial tecnológico do seu negócio.</span>
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="aspect-square bg-gray-900/50 rounded-xl overflow-hidden"
              >
                <img 
